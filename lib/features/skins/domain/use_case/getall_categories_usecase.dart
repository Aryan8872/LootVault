...
class GetallCategoriesUsecase implements UsecaseWithoutParams<List<GameCategoryEntity>>{
  final IGameRepository gameRepository;
  final TokenSharedPrefs tokenSharedPrefs;

  GetallCategoriesUsecase({required this.gameRepository, required this.tokenSharedPrefs});
